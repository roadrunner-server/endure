...
import (
	...
	"github.com/roadrunner-server/endure/tests/interfaces/named/randominterface"
	"github.com/roadrunner-server/endure/tests/interfaces/named/registers"
	"github.com/roadrunner-server/endure/tests/interfaces/named/registersfail"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin1"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin10"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin2"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin3"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin4"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin5"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin6"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin7"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin8"
	"github.com/roadrunner-server/endure/tests/interfaces/plugins/plugin9"
	notImplPlugin1 "github.com/roadrunner-server/endure/tests/interfaces/service/not_implemented_service/plugin1"
	notImplPlugin2 "github.com/roadrunner-server/endure/tests/interfaces/service/not_implemented_service/plugin2"

	collects_get_all_deps "github.com/roadrunner-server/endure/tests/interfaces/collects/collects_get_all_deps"
